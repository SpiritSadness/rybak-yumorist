...
<b>Поддержка</b>
Нашли баг или что-то сломалось — напишите @Andrey720p.
Кратко опишите проблему и, если можно, приложите скрин.

<b>Технически</b>
• Платформа: Node.js ${process.versions.node}
• Анекдоты: anekdot.ru (тег «рыбалка»), обновление базы раз в 7 дней
• Рассылка в группы (МСK): 04:00 · 07:00 · 09:00 · 14:00 · 18:00 · 23:00
...
function formatCityWeather(weather, updatedAt = null) {
  if (!weather) {
    return appendUpdatedAt(
      '☀️ <b>Погода</b>\n\n😕 Не удалось загрузить данные.\n\nПроверь VPN (Happ) и нажми 🔄 Обновить.',
      updatedAt
    );
  }
